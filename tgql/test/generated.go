...
type QueryResolver interface {
	Users(ctx context.Context, query *string) (*User, error)
}
...
var sources = []*ast.Source{
	&ast.Source{Name: "model_test_schema.graphql", Input: `scalar Map
scalar Int64
scalar Any
...
type User @goModel(model:"github.com/zhanghup/go-tools/tgql/test.User"){
    id: String
    "排序"
    weight: Int
    "状态"
...
func (ec *executionContext) _Query_users(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Users(rctx, args["query"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*User)
	fc.Result = res
	return ec.marshalOUser2ᚖgithubᚗcomᚋzhanghupᚋgoᚑtoolsᚋtgqlᚋtestᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOUser2githubᚗcomᚋzhanghupᚋgoᚑtoolsᚋtgqlᚋtestᚐUser(ctx context.Context, sel ast.SelectionSet, v User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalOUser2ᚖgithubᚗcomᚋzhanghupᚋgoᚑtoolsᚋtgqlᚋtestᚐUser(ctx context.Context, sel ast.SelectionSet, v *User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)

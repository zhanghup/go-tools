...
func WGS84toGCJ02(lon, lat float64) (float64, float64) {
	if __isOutOFChina(lon, lat) {
		return lon, lat
	}

	mgLon, mgLat := __delta(lon, lat)
...
func __delta(lon, lat float64) (float64, float64) {
	dlat := __transformlat(lon-105.0, lat-35.0)
	dlon := __transformlng(lon-105.0, lat-35.0)
...
func __transformlat(lon, lat float64) float64 {
...
func __transformlng(lon, lat float64) float64 {
...
func __isOutOFChina(lon, lat float64) bool {
